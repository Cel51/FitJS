...
class MealsControllerTest < ActionController::TestCase
  ...
  test "should create meal" do
    assert_difference('Meal.count') do
      post :create, meal: { date: @meal.date, meal_type_id: @meal.meal_type_id, user_id: @meal.user_id }
    end
  ...
  test "should update meal" do
    patch :update, id: @meal, meal: { date: @meal.date, meal_type_id: @meal.meal_type_id, user_id: @meal.user_id }
    assert_redirected_to meal_path(assigns(:meal))
  end
