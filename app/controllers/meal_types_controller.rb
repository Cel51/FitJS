class MealTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @meal_type.save
        format.html { redirect_to @meal_type, notice: 'Type de repas crée.' }
  ...
  def update
    respond_to do |format|
      if @meal_type.update(meal_type_params)
        format.html { redirect_to @meal_type, notice: 'Type de repas mis à jour.' }
  ...
  def destroy
    @meal_type.destroy
    respond_to do |format|
      format.html { redirect_to meal_types_url, notice: 'Type de repas supprimé.' }
